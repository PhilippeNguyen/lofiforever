...
class PipeClient:
    ...
    def __init__(self, enc="", timeout=30):
        self.timer = False
        self._start_time = 0
    ...
    def do_command_no_wait(self, command, print_response=False):
    ...
    def do_command_and_wait(self, command, print_response=False, timeout=None):
        """Send one command, and return the response."""
        if timeout is None:
